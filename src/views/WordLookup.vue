<template>
    <div class="word-lookup-container">
      ...
      <el-header class="header">
        <!-- Use router instance to navigate back -->
      ...
      <el-main class="main-content">
        ...
        <!-- 查询结果 -->
        <div v-if="result && result.word !== '未找到结果'" class="result-section">
  ...
  // Import useRouter to fix navigation issue
  ...
  // Go back to the previous page using the router instance
  const goBack = () => {
    router.back()
  }
  </script>
